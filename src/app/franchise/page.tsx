...
export default function FranchisePage() {
  ...
  const costs = months.map((m) => Math.round(220 - m * 4));
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <div className="bg-[#0A1628] text-[#F5E6C8] rounded-2xl p-6 md:p-10 mb-12">
            <div className="inline-flex items-center gap-2.5 font-[family-name:var(--font-jetbrains)] text-[11px] uppercase tracking-[0.18em] text-[rgba(245,230,200,0.5)] mb-4">
              12-month unit projection
            </div>
              ...
              {done ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="font-[family-name:var(--font-playfair)] text-2xl mb-2">
                    Reference <em className="text-[#C97B2A] not-italic">#APP-{Math.floor(Math.random()*90000+10000)}</em>
                  </h3>
