...
const territoryItems = ["Your colours", "Your city", "Your influence", "Your legacy"];
const territoryDescriptions = [
  "Picked with our team, signed off by you.",
  "3km exclusive radius around your door.",
  "You vote on menu specials, events, and partnerships.",
  "The crest retires when you retire.",
];
...
export default function BrandClientPage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <h1 className="font-[family-name:var(--font-serif)] font-extrabold tracking-[-0.035em] leading-[0.95] text-[clamp(48px,6vw,96px)] mb-6">
            Two obsessions.<br />
            <span className="text-[color:var(--color-pp-accent)] font-medium">One crest.</span>
          </h1>
      ...
      <section id="pasta" className="py-16 md:py-24 bg-white scroll-mt-20">
        <div className="max-w-[1280px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-[family-name:var(--font-serif)] font-extrabold tracking-[-0.035em] leading-[0.95] text-[clamp(32px,4vw,64px)] mb-6">
              Made at 6am.<br />
              <span className="text-[color:var(--color-pp-accent)] font-medium">Served by noon.</span>
            </h2>
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-10">
              {brandStats.map((s) => (
                <div key={s.l}>
                  ...
                  <div className="font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.12em] text-[color:var(--color-pp-mute)] mt-1">{s.l}</div>
      ...
      <section id="colour" className="py-16 md:py-24 bg-[color:var(--color-pp-primary)] text-[color:var(--color-pp-cream)] scroll-mt-20">
        <div className="max-w-[1280px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="kicker kicker-dark mb-6">02 · Colour & Territory</div>
            <h2 className="font-[family-name:var(--font-serif)] font-extrabold tracking-[-0.035em] leading-[0.95] text-[clamp(32px,4vw,64px)] mb-6">
              Colour is <span className="text-[color:var(--color-pp-tertiary)] font-medium">territory.</span>
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {territoryItems.map((t, i) => (
                <div key={t} className="bg-[rgba(245,230,200,0.05)] rounded-[var(--radius-lg)] p-5 border border-[rgba(245,230,200,0.1)]">
                  ...
                  <p className="text-sm text-[rgba(245,230,200,0.7)]">{territoryDescriptions[i]}</p>
                </div>
              ))}
            </div>
            <div className="flex flex-wrap gap-3">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
              ...
              <h2 className="font-[family-name:var(--font-serif)] font-extrabold tracking-[-0.035em] leading-[0.95] text-[clamp(32px,4vw,64px)] mb-4">
                ...
                <span className="text-[color:var(--color-pp-accent)] font-medium">the whole store changes colour.</span>
              </h2>
            </div>
